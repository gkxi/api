...
pub mod tran_v1_server {
    ...
    #[async_trait]
    pub trait TranV1: std::marker::Send + std::marker::Sync + 'static {
        async fn chain_list(
            &self,
    ...
    impl<T> Clone for TranV1Server<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "tran.v1.TranV1";
    impl<T> tonic::server::NamedService for TranV1Server<T> {
