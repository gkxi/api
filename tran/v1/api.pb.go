...
func (x *GasPriceReply) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GasPriceReply) ProtoMessage() {}

func (x *GasPriceReply) ProtoReflect() protoreflect.Message {
	mi := &file_tran_v1_api_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GasPriceReply.ProtoReflect.Descriptor instead.
func (*GasPriceReply) Descriptor() ([]byte, []int) {
	return file_tran_v1_api_proto_rawDescGZIP(), []int{9}
}

func (x *GasPriceReply) GetGasPrice() string {
	if x != nil {
		return x.GasPrice
	}
	return ""
...
var file_tran_v1_api_proto_rawDesc = []byte{
	...
	0x6c, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x11, 0x0a, 0x0f, 0x47, 0x61, 0x73, 0x50,
	0x72, 0x69, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x2b, 0x0a, 0x0d, 0x47,
	0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1a, 0x0a, 0x08,
	0x67, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x67, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x22, 0xc7, 0x01, 0x0a, 0x0f, 0x53, 0x65, 0x6e,
	...
	0x12, 0x6b, 0x0a, 0x08, 0x47, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x18, 0x2e, 0x74,
	0x72, 0x61, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x74, 0x72, 0x61, 0x6e, 0x2e, 0x76, 0x31,
	0x2e, 0x47, 0x61, 0x73, 0x50, 0x72, 0x69, 0x63, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x2d,
	...
	0x68, 0x61, 0x69, 0x6e, 0x2f, 0x67, 0x61, 0x73, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x6b, 0x0a,
...
var file_tran_v1_api_proto_goTypes = []interface{}{
	...
	(*GasPriceRequest)(nil),              // 8: tran.v1.GasPriceRequest
	(*GasPriceReply)(nil),                // 9: tran.v1.GasPriceReply
...
var file_tran_v1_api_proto_depIdxs = []int32{
	...
	8,  // 13: tran.v1.TranV1.GasPrice:input_type -> tran.v1.GasPriceRequest
	...
	9,  // 22: tran.v1.TranV1.GasPrice:output_type -> tran.v1.GasPriceReply
