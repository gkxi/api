...
type MinerFee1Request struct {
	...
	Multiple int64 `protobuf:"varint,4,opt,name=multiple,proto3" json:"multiple,omitempty"`
}
...
func (x *MinerFee1Request) GetMultiple() int64 {
	if x != nil {
		return x.Multiple
	}
	return 0
...
type SendTranRequest struct {
	...
	Multiple        int64   `protobuf:"varint,8,opt,name=multiple,proto3" json:"multiple,omitempty"`
}
...
func (x *SendTranRequest) GetMultiple() int64 {
	if x != nil {
		return x.Multiple
	}
	return 0
...
var file_tran_v1_api_proto_rawDesc = []byte{
	...
	0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x65, 0x22,
	...
	0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x8f, 0x01,
	...
	0x6c, 0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x70,
